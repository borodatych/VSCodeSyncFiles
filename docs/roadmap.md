...
- **[v1 →](v1/roadmap.md)** — первая полноценная версия расширения (закрыта в 0.5.0)
- **[v2 →](v2/roadmap.md)** — стратегические направления: P2P, Passkey, BLAKE3 migration, tunnel spawn, декомпозиция extension.ts. Детальная разбивка: [v2/breakdown.md](v2/breakdown.md).
- **[v3 →](v3/roadmap.md)** — следующие направления: selective sync, cost dashboard, multi-account, key rotation wizard, visual merger, AI reviewer, backup verification, per-folder strategy, и др.

## Быстрая ссылка на текущий статус

→ [docs/v2/breakdown.md](v2/breakdown.md) (актуальный список открытых пунктов после закрытия v1)
