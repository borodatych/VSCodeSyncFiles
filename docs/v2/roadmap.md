...
>
> **Детальная разбивка по подэтапам с чекбоксами:** [v2/breakdown.md](breakdown.md) —
> там 100+ конкретных пунктов, каждый закрываемый отдельно (один фокусированный прогон).
> /roadmap-max будет инкрементально подхватывать их в порядке зависимостей.
