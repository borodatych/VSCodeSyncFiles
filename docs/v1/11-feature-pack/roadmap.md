...
- [~] Стабилизировать 8 flaky тестов на main — закрыто 7 из 8 на roadmap-max pass; остаётся `engineCallbacks > onNewConflict 3-way` (hard race, требует root-cause refactor мета-патч pipeline).
